...
<body>
    ...
    include_once $_SERVER['DOCUMENT_ROOT'] . "/despliegueServidor/php/POO_RIDAA/app/models/Car.php";
    include_once $_SERVER['DOCUMENT_ROOT'] . "/despliegueServidor/php/POO_RIDAA/app/models/Motorbike.php";
    include_once $_SERVER['DOCUMENT_ROOT'] . "/despliegueServidor/php/POO_RIDAA/app/models/Van.php";
    include_once $_SERVER['DOCUMENT_ROOT'] . "/despliegueServidor/php/POO_RIDAA/app/models/Rental.php";
    include_once $_SERVER['DOCUMENT_ROOT'] . "/despliegueServidor/php/POO_RIDAA/app/models/Customer.php";
    include_once $_SERVER['DOCUMENT_ROOT'] . "/despliegueServidor/php/POO_RIDAA/app/models/Concessionaire.php";
    ...
    $concessionaire = new Concessionaire("Rida S.A.", [$car, $moto, $van], [$customer]);
    ...
    echo "<div class=\"vehicle\"><h2>" . $car->vehicleName() . "</h2>$car</div>";
    echo "<div class=\"vehicle\"><h2>" . $moto->vehicleName() . "</h2>$moto</div>";
    echo "<div class=\"vehicle\"><h2>" . $van->vehicleName() . "</h2>$van</div>";
    echo "</div>"; 
